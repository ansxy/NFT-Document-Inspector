        ...
        <div className="w-full h-full flex flex-nowrap justify-center mt-60">
          ...
          <div className="flex w-1/2 h-1/2 justify-center">
            <div className=" h-1/2 w-4/5 flex flex-col items-center justify-center gap-4">
              ...
              <form className="flex flex-row mt-6 w-full">
                <button
                  onClick={findKTP}
                  className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 p-2.5 rounded-l-lg text-sm text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 font-bold"
                >
                  SEARCH
                </button>
                <input
